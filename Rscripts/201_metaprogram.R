# 2026-05-15
# NMF based metaprogram discovery as in Gavish et al. nature 2023, continued from 200_...R
...
saveRDS(
  ...
  file = "RDSfiles/meta_program_results.rds"
)
